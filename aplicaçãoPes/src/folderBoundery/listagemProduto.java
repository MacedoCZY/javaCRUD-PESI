 ...
 */
package folderBoundery;

import aplicaçãopes.AplicaçãoPes;
import folderControl.ctrlEditProd;
import folderControl.ctrlListProd;
import folderControl.ctrlViewProd;
...
public class listagemProduto extends javax.swing.JFrame {
    ...
    public listagemProduto() {
        initComponents();
        jListListagem.setFont(new Font(Font.MONOSPACED, Font.BOLD, 12));
        block();
        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
    }
    
    public void block(){
        buttonCadProd.setEnabled(jListListagem.isSelectedIndex(jListListagem.getSelectedIndex()));
        buttonViewProd.setEnabled(jListListagem.isSelectedIndex(jListListagem.getSelectedIndex()));
        buttonEditProd.setEnabled(jListListagem.isSelectedIndex(jListListagem.getSelectedIndex()));
    }
    ...
    private void initComponents() {
        ...
        jListListagem.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jListListagemMouseClicked(evt);
            }
        });
    ...
    private void jListListagemMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jListListagemMouseClicked
        // TODO add your handling code here:
        block();
    }//GEN-LAST:event_jListListagemMouseClicked
